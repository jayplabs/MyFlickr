...
import com.chandra.myflickr.flickr.cache.FlushedInputStream;
...
public class PhotoUtils {
    private static final Logger logger = LoggerFactory.getLogger(PhotoUtils.class.getSimpleName());
    ...
    public static Bitmap downloadImage(String url) {
        ...
        try {
            ...
            if (statusCode != HttpStatus.SC_OK) {
                logger.warn("ImageDownloader", "Error " + statusCode //$NON-NLS-1$//$NON-NLS-2$
